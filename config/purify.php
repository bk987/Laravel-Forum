    ...
    */
    ...
    'settings' => [
        ...
        */
        ...
        'HTML.Allowed' => 'h4,b,strong,em,del,a[href],ul,ol,li,div,p,br,span,pre,img[width|height|alt|src]',
        ...
        */
        ...
        'CSS.AllowedProperties' => 'text-decoration,padding-left,text-align',
